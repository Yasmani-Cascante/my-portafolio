        ...
        <div className="max-w-screen border-b min-h-full relative ">
            ...
            >
                ...
                <div className="ml-5 sm:ml-20 lg:ml-28 pt-28 md:pt-36 max-w-[69rem]">
                    <span className="text-6xl block">Freelance</span>
                ...
                <div className="ml-16 mt-4">
                    <h1 className='masthead-title inline'>Web Designer & Developer</h1>
                </div>
                ...
                <span className="masthead-title__span ml-7 text-9xl">&</span><span className="block ">Designer</span> <span>Developer</span> </h1> */}
                    <div className="masthead-contact-row mt-[10rem] max-w-sm ml-32">
...
{/*                       
                     ...
                     <a href="#" className="absolute bottom-44 right-64 border rounded-full px-12 py-20"> 
                        {/* <ArrowDownSvg 
                        className=""
                        /> */}
