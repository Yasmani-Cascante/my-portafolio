    ...
    return (
        <div className="max-w-screen border-b min-h-full relative ">
            ...
            >
                ...
                <h1 className='inline relative masthead-title'>Creative Web Designer <span className="masthead-title__span">&</span> <span>Developer</span> </h1>
                ...
                <span className="masthead-title__span ml-7 text-9xl">&</span><span className="block ">Designer</span> <span>Developer</span> </h1> */}
                    <div className="masthead-contact-row mt-[8rem] max-w-sm ml-20">
...
{/*                       
                     ...
                     <a href="#" className="absolute bottom-36 right-64 border rounded-full px-20 py-16"> 
                        <ArrowDownSvg 
                        className=""
                        />
                    </a>    
