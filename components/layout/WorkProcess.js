                ...
                <ul className="">
                   <li className="proccess-card border-b hover:bg-yellow transition-all duration-300">
                    <div className="flex md:items-end w-11/12 p-8 lg:p-16 flex-col md:flex-row ">
                        <span className="text-process_index font-bold mr-6 leading-[4.8rem] text-7xl text-[6.953rem] mb-8 md:mb-14 md:mb-0">01.</span>
                        <div className="flex flex-col gap-y-6 md:gap-y-8">
                            <h3 className="whitespace-normal">BRIEF AND ANALYTICS</h3>
                   ...
                   <li className="proccess-card border-b hover:bg-yellow transition-all duration-300">
                    <div className="flex md:items-end w-11/12 p-8 lg:p-16 flex-col md:flex-row">
                        <span className="text-process_index font-bold mr-6 leading-[4.8rem] text-7xl md:text-[6.953rem] mb-8 md:mb-14 md:mb-0">02.</span>
                        <div className="flex flex-col gap-y-8">
                            <h3 className="whitespace-normal">DESIGN and PROTOTYPE</h3>
                   ...
                   <li className="proccess-card hover:bg-yellow transition-all duration-300">
                    <div className="flex md:items-end w-11/12 p-8 lg:p-16 flex-col md:flex-row">
                        <span className="text-process_index font-bold mr-6 leading-[4.8rem] text-7xl md:text-[6.953rem] mb-8 md:mb-14 md:mb-0">03.</span>
                        <div className="flex flex-col gap-y-8">
                            <h3 className="whitespace-normal">LAYOUT AND LAUNCH</h3>
                            <p>CREATE A WEBSITE PROTOTYPE TAKING INTO ACCOUNT THE USER EXPERIENCE (UX). AFTER APPROVAL, I DEVELOP TWO VISUAL DESIGN CONCEPTS (UI) FOR 2 BLOCKS (THE MAIN SCREEN AND THE SUBSEQUENT BLOCK), THEN I START FULL-FLEDGED DEVELOPMENT BASED ON THE SELECTED CONCEPT.</p>
                        </div>
                    </div> 
                   </li>
