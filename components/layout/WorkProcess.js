    ...
    return (
        <section className="max-w-screen border-b">
            ...
            <div className="container border-x ">
                <ul className="">
                   <li className="proccess-card border-b group hover:bg-yellow dark:hover:bg-blue transition-all duration-300">
                   ...
                   <li className="proccess-card group hover:bg-yellow  dark:hover:bg-blue transition-all duration-300">
                    <div className="flex md:items-end w-11/12 p-8 lg:p-16 flex-col md:flex-row">
