        ...
        <section className="max-w-screen border-b">
            <div className="container border-x flex flex-col-reverse lg:flex-row justify-between items-center pb-20 lg:pb-0">
                <div className="flex flex-col max-w-lg lg:max-w-md px-8 xl:ml-16">
                    ...
                    <p className="mt-12 mb-10">Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui, nihil. 
                    ...
                    <button className="group font-bold large shadow-custom flex justify-between items-center hover:shadow-none hover:translate-x-1 transition-all mt-6">
