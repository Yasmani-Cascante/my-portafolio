        ...
        >
            <div className="project-card__body">
                <div className="project-card__header flex flex-row items-end z-10">
                    ...
                    <div className="project-card__tags ml-2 z-10">
                        {location?  
                            // refactLocation(location)
                            <span className="px-2 text-black/75 dark:text-white-dark uppercase text-xs">{location}</span> 
                        :null}
                ...
                {/* {case_study?  
                 <div className="px-2 bg-black-dark text-white-dark uppercase text-xs">Case Study</div> 
                :null} */}
                ...
                <p className="mt-6 max-w-[60%] text-black/60 group-hover:text-black-lighten"> { project_description } </p>
