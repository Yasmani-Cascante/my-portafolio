...
function Project_card({project}) {
    ...
    return (
        <div className="project-card flex flex-col transition-all duration-300 p-8 md:p-8 md:py-16 lg:p-16 border border-t-0 border-r-0">
