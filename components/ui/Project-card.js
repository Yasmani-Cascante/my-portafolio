...
function Project_card() {
    return (
        <div className="project-card transition-all duration-300 p-8 md:p-16 border border-t-0 border-r-0">
            <div className="project-card__header flex md:items-end flex-col md:flex-row">
                <h3>Project title</h3>
                <span className="text-black-light md:ml-auto font-bold mt-2">March 12, 2021</span>
            </div>
            ...
            <div className="project-card__footer flex md:items-baseline pt-4">
