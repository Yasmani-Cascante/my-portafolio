...
const getCity = (tag , index) => {
    ...
    return (
        ...
        onHoverEnd={() => setImageSwitcher('hide')}
        >
            <div className="project-card__body w-[90%]">
                <div className="project-card__header flex flex-row items-end z-10 ">
                    <h3 className="text-black/85 uppercase text-3xl"> { project_title } </h3>
                    <div className="location-wrapper ml-3">
            ...
            > */}
                        ...
                        // >
                            ...
                            //   className="  bg-black-bg/90 dark:bg-white-bg w-28 h-28 p-3 absolute bottom-6 right-12 flex items-center rounded-full hover:text-white-bg z-10"
                              className=" dark:bg-white-bg w-36 h-36 p-3 absolute bottom-6 right-6 flex items-center rounded-full hover:text-white-bg z-10"
