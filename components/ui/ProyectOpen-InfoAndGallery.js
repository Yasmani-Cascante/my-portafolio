...
// import bg_noise_noise from "../../public/assets/img/Noise.png";
...
{/* 
        ...
        <div className="card-open__header md:px-28">
            ...
            <p className="mt-20  mb-24"> { project_description } </p>
            { project_tags.map((tag, index) => (
                        <span key={index} className="font-bold mr-4 border rounded-3xl px-6 py-2 dark:text-white-dark">{tag.name}</span>
                    ))}
        </div>
           
                
        <div className="relative project-card-open">
        {/* <div className="bg_noise"></div> */}
