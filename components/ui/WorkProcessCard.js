  ...
  const variants = {
    ...
    return (
       <motion.div 
        ...
        className=" hover:shadow-none relative proccess-card border-b group transition-all duration-300"
        >
            <motion.div 
            ...
            <div className="flex md:items-end w-11/12 p-8 lg:p-16 flex-col md:flex-row ">
                <span className="text-process_index font-bold mr-6 leading-[4.8rem] text-7xl text-[5.25rem] mb-8 md:mb-0 text-black dark:text-white-dark group-hover:text-black-lighten">0{data.data.id}.</span>
